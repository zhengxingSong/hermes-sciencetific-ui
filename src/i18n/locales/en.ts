export default {
  ...
  settings: {
    ...
    webUi: {
      ...
      authEnabledHint: 'Whether Web UI requires API Key authentication',
      apiKey: 'API Key',
      apiKeyHint: 'Authentication key for Web UI access, must match HERMES_WEB_API_KEY env variable on server',
      generate: 'Generate',
      clearKey: 'Clear',
      keyCleared: 'API Key cleared',
      keySaved: 'Saved locally, ready to use',
      authHint: 'Setting API Key protects Web UI from unauthorized access. In development mode (NODE_ENV=development) without server key, auth is automatically skipped.',
      serverConfig: 'Server Configuration',
      envHint: 'Server requires matching environment variable:',
      matchingHint: 'Ensure the API Key set here matches the HERMES_WEB_API_KEY environment variable on server, otherwise API access will be denied.',
    },
    display: {
